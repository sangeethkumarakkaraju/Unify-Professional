			...
			<div class="container">
				...
				<p class="copyright"><span class="copyright-date">
						<?php 
							...
							printf( esc_html_x( '&copy; Copyright %1$s', '%1$s - current year','Unify' ), esc_html($current_year) );
						?>
                    </span>
					<?php
					?>
					  ...
					  <?php printf(__('&#8226; Designed by ',  'Data-magnum')); ?><a href="<?php echo esc_url(__('http://www.data-magnum.com/', 'data magnum')); ?>"  rel="nofollow" title="<?php esc_attr_e('The big data connection', 'data-magnum' ); ?>"><?php _e('Data Magnum',  'data-magnum' ); ?></a>
					  <?php
					?>
				</p><!-- .copyright -->
			</div>
